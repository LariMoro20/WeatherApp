                ...
                <div className="col-md-12 row weather_form-header">
                    ...
                    <div className='col-md-12'>
                        <ol>
                            ...
                            <li className='weather_help-list'> Escolha um nome para sua chave, e sem seguida a opção de uso interno. Apenas estas duas configurações são suficientes. Em seguida, clique em "Criar chave"<img className="full" alt='site' src='images/help/4.png' /></li>
