        ...
        <div className="row">
            <div className="weather__form row">
                <div className="col-md-12 weather__form-header">
                    <h1>Ajuda</h1>
                    <p>Saiba aqui como criar sua própria chave de acesso gratuita e usa-la na plataforma </p>
                </div>
                <div className="col-md-12 row weather__form-header">
                    ...
                    <div className='col-md-12'>
                        <ol>
                            ...
                            <li className='weather_help-list'> De volta a aplicação, cole a chave no campo indicado juntamente com os outros dados de sua pesquisa. Clique em  "Procurar" e visualize o resultado!</li>
